...
public class cadastroEndereco extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Cadastrar Endereço");

        jButton1.setText("Cadastrar");
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCadastarEndActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jtfEstado, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE))
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        .addComponent(jtfRua, javax.swing.GroupLayout.DEFAULT_SIZE, 197, Short.MAX_VALUE)
                                        .addComponent(jtfCEP))
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(jLabel2)))
                            .addGap(7, 7, 7)
                            .addComponent(jtfnumCasa, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(46, 46, 46))
                        .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void btnCadastarEndActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastarEndActionPerformed
            // TODO add your handling code here:
        if(jtfRua.getText().equals("")){
            JOptionPane.showMessageDialog(null,"É necessário escolher uma Rua",null,WIDTH);
            return;
        }
        
        if(jtfnumCasa.getText().equals("")){
            JOptionPane.showMessageDialog(null,"É necessário escolher um número",null,WIDTH);
            return;
        } 
        
        if(jtfCEP.getText().equals("")){
            JOptionPane.showMessageDialog(null,"É necessário escolher um CEP",null,WIDTH);
            return;
        }      
        
        if(jtfCidade.getText().equals("")){
            JOptionPane.showMessageDialog(null,"É necessário escolher uma Cidade",null,WIDTH);
            return;
        }

        if(jtfEstado.getText().equals("")){
            JOptionPane.showMessageDialog(null,"É necessário escolher um Estado",null,WIDTH);
            return;
        } 
	
        String rua = jtfRua.getText();
        int numero = Integer.parseInt((String)jtfnumCasa.getText());
        ...
        end = new Endereco(rua, numero, cep, cidade, estado);
               
        conexaoEndereco teste = new conexaoEndereco();
               
        boolean deu_certo = teste.cadastroEndereco(end);
        ...
        dispose();
// TODO add your handling code here:
    }//GEN-LAST:event_btnCadastarEndActionPerformed
